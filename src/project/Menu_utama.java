...
import koneksi.LaptopDB;
import koneksi.PartKomputerDB;
import koneksi.MobileDB;
import koneksi.ProductList;
import koneksi.Search;
...
public class Menu_utama extends javax.swing.JFrame {
    ...
    public Menu_utama() {
        ...
        ArrayList<ProductList> list = LaptopDB.homePageContent();
        ...
        list = PartKomputerDB.homePageContent();
    ...
    private void initComponents() {
        ...
        partkButton = new javax.swing.JButton();
        ...
        partkPanel = new javax.swing.JPanel();
        jScrollPane4 = new javax.swing.JScrollPane();
        partkTable = new javax.swing.JTable();
        ...
        jLabel1.setText("Kamaludin Comp");
        ...
        newlyAdded.setText("Baru Ditambahkan");
        newlyAdded.setToolTipText("Periksalah apa yang baru!");
        ...
        laptopButton.setBackground(new java.awt.Color(0, 150, 136));
        laptopButton.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        laptopButton.setForeground(new java.awt.Color(255, 255, 255));
        laptopButton.setText("Laptop");
        laptopButton.setToolTipText("Laptop Murah Sejagad Raya Bos!");
        ...
        laptopButton.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                laptopButtonMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                laptopButtonMouseReleased(evt);
            }
        });
        ...
        accountButton.setToolTipText("Info Akun");
        ...
        cartButton.setToolTipText("Tampilan Keranjang");
        ...
        mobilesButton.setToolTipText("HandPhone Murah Berkualitas!");
        ...
        partkButton.setBackground(new java.awt.Color(0, 150, 136));
        partkButton.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        partkButton.setForeground(new java.awt.Color(255, 255, 255));
        partkButton.setText("Part Komputer");
        partkButton.setToolTipText("Harga Murah Kualitas Oke!");
        partkButton.setBorderPainted(false);
        partkButton.setContentAreaFilled(false);
        partkButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        partkButton.setOpaque(true);
        partkButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                partkButtonMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                partkButtonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                partkButtonMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                partkButtonMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                partkButtonMouseReleased(evt);
            }
        });
        partkButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                partkButtonActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addComponent(laptopButton, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
                .addComponent(mobilesButton, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(partkButton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 254, Short.MAX_VALUE)
                .addComponent(cartButton, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(laptopButton, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addComponent(partkButton, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        homeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Brand", "Model", "Harga", "Stock", "Features", "Photo"
            }
        ) {
        ...
        laptopTable.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        laptopTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        laptopTable.setSelectionBackground(new java.awt.Color(0, 150, 136));
        ...
        jScrollPane3.setViewportView(laptopTable);
        ...
        cardParentPanel.add(laptopPanel, "card4");
        ...
        cartItemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Produk", "Model", "Harga", "Quantity"
            }
        ));
        ...
        jLabel5.setText("Total Bayar : Rp. ");
        ...
        partkTable.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        partkTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        partkTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        partkTable.setSelectionBackground(new java.awt.Color(0, 150, 136));
        partkTable.getTableHeader().setReorderingAllowed(false);
        partkTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                partkTableMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(partkTable);

        javax.swing.GroupLayout partkPanelLayout = new javax.swing.GroupLayout(partkPanel);
        partkPanel.setLayout(partkPanelLayout);
        partkPanelLayout.setHorizontalGroup(
            partkPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 1200, Short.MAX_VALUE)
        );
        partkPanelLayout.setVerticalGroup(
            partkPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 590, Short.MAX_VALUE)
        );

        cardParentPanel.add(partkPanel, "card2");
        ...
        jLabel13.setText("Sudah Memiliki Akun?");
        ...
        jLabel14.setText("Nomor Kartu(Optional)");
        ...
        jLabel21.setText("Belum Bergabung?");
    ...
    private void laptopButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopButtonMouseClicked
        // TODO add your handling code here:
        cardParentPanel.removeAll();
        cardParentPanel.add(laptopPanel);
        cardParentPanel.repaint();
        cardParentPanel.revalidate();
    }//GEN-LAST:event_laptopButtonMouseClicked

    private void laptopButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopButtonMouseEntered
        // TODO add your handling code here:
         laptopButton.setBackground(new Color(0, 137, 123));
    ...
    private void laptopButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopButtonMouseExited
        // TODO add your handling code here:
        laptopButton.setBackground(new Color(0, 150, 136));
    }//GEN-LAST:event_laptopButtonMouseExited

    private void laptopButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopButtonMousePressed
        // TODO add your handling code here:
        laptopButton.setBackground(new Color(0, 77, 64));
    }//GEN-LAST:event_laptopButtonMousePressed

    private void laptopButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopButtonMouseReleased
        // TODO add your handling code here:
         laptopButton.setBackground(new Color(0, 150, 136));
    }//GEN-LAST:event_laptopButtonMouseReleased
    ...
    private void laptopButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_laptopButtonActionPerformed
        ...
        ArrayList<ProductList> list = LaptopDB.TableGenerator();
        Object rowData[] = new Object[6];
        
        DefaultTableModel model =  (DefaultTableModel) laptopTable.getModel();
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        laptopTable.getColumnModel().getColumn(0).setCellRenderer( centerRenderer );
        laptopTable.getColumnModel().getColumn(1).setCellRenderer( centerRenderer );
        laptopTable.getColumnModel().getColumn(2).setCellRenderer( centerRenderer );
        laptopTable.getColumnModel().getColumn(3).setCellRenderer( centerRenderer );
        laptopTable.getColumnModel().getColumn(4).setCellRenderer( centerRenderer );
        ...
        for(int i=0; i<list.size(); i++){
            ...
            rowData[5] = ii;
            model.addRow(rowData);
            laptopTable.setRowHeight(150);
            laptopTable.getColumnModel().getColumn(5).setPreferredWidth(150);
        }
    ...
    private void partkButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkButtonMouseClicked
        // TODO add your handling code here:
        cardParentPanel.removeAll();
        cardParentPanel.add(partkPanel);
        cardParentPanel.repaint();
        cardParentPanel.revalidate();
    }//GEN-LAST:event_partkButtonMouseClicked

    private void partkButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkButtonMouseEntered
        // TODO add your handling code here:
        partkButton.setBackground(new Color(0, 137, 123));
    }//GEN-LAST:event_partkButtonMouseEntered

    private void partkButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkButtonMouseExited
        // TODO add your handling code here:
        partkButton.setBackground(new Color(0, 150, 136));
    }//GEN-LAST:event_partkButtonMouseExited

    private void partkButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkButtonMousePressed
        // TODO add your handling code here:
        partkButton.setBackground(new Color(0, 77, 64));
    }//GEN-LAST:event_partkButtonMousePressed

    private void partkButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkButtonMouseReleased
        // TODO add your handling code here:
        partkButton.setBackground(new Color(0, 150, 136));
    }//GEN-LAST:event_partkButtonMouseReleased

    private void partkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_partkButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "kids";
        ArrayList<ProductList> list = PartKomputerDB.TableGenerator();
        Object rowData[] = new Object[6];
        
        DefaultTableModel model =  (DefaultTableModel) partkTable.getModel();
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        partkTable.getColumnModel().getColumn(0).setCellRenderer( centerRenderer );
        partkTable.getColumnModel().getColumn(1).setCellRenderer( centerRenderer );
        partkTable.getColumnModel().getColumn(2).setCellRenderer( centerRenderer );
        partkTable.getColumnModel().getColumn(3).setCellRenderer( centerRenderer );
        partkTable.getColumnModel().getColumn(4).setCellRenderer( centerRenderer );
        ...
        for(int i=0; i<list.size(); i++){
            ...
            rowData[5] = ii;
            model.addRow(rowData);
            partkTable.setRowHeight(150);
            partkTable.getColumnModel().getColumn(5).setPreferredWidth(150);
        }
        
    }//GEN-LAST:event_partkButtonActionPerformed
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        ...
        if(signInUsernameField.getText().equals("admin") && signInPasswordField.getText().equals("admin")){
            ...
            boolean flag = Koneksi.signer(signInUsernameField.getText(), signInPasswordField.getText());
            ...
            if(flag){
                ...
                if(wrongPass>=3){
                    LupaPassFrame fpf = new LupaPassFrame();
                }
    ...
    private void LogUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogUpButtonActionPerformed
        ...
        if(signUpUsernameField.getText().equals("")||signUpNameField.getText().equals("")||signUpEmailField.getText().equals("")
           ||signUpPasswordField.getText().equals(""))
            ...
            int test = Koneksi.insertToUser(signUpUsernameField.getText(), signUpNameField.getText(),
    ...
    private void laptopTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laptopTableMouseClicked
        ...
        TableModel tm = laptopTable.getModel();
    ...
    private void partkTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_partkTableMouseClicked
        // TODO add your handling code here:
        pi.setVisible(true);
        pi.pack();
        
        int selectedRow = partkTable.getSelectedRow();
        TableModel tm = partkTable.getModel();
        ...
        pi.productInfoFeature.setText(feature);
        pi.productPhoto.setIcon(img);
    }//GEN-LAST:event_partkTableMouseClicked
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(searchBar.getText().equals(""))
        ...
        else if(Search.laptop==0 && Search.mobile==0 && Search.partkomputer==0)
            ...
            for(k=i; k<Search.mobile+Search.laptop; k++){
            ...
            System.out.println();
            for(j=k; j<Search.mobile+Search.laptop+Search.partkomputer; j++){
    ...
    private void searchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchTableMouseClicked
        ...
        if(Search.laptop!=0 && rowIndex<Search.laptop)
            ProductInformation.categoryChooser = "laptop";
        else if(Search.mobile!=0 && rowIndex>=Search.laptop && rowIndex<Search.laptop+Search.mobile)
            ProductInformation.categoryChooser = "mobiles";
        else 
            ProductInformation.categoryChooser = "partkomputer";
...
//            }
//        });
        JFrame newMain = new Menu_utama();
        newMain.setTitle("Kamaludin Comp");
    ...
    private javax.swing.JButton partkButton;
    private javax.swing.JPanel partkPanel;
    private javax.swing.JTable partkTable;
