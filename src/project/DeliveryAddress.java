...
import static project.Menu_utama.logger;
...
public class DeliveryAddress extends javax.swing.JFrame {
    ...
    private void finalizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizeActionPerformed
        this.dispose();
        DefaultTableModel dt = (DefaultTableModel) Menu_utama.cartItemTable.getModel();
        dt.setRowCount(0);
        Menu_utama.billLabel.setText("0");
