...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateButton.setText("Tambah Barang");
        ...
        mPhotoPath.setText("Masukan Fotonya:");
        ...
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptop", "Mobile", "Part Komputer." }));
        ...
        checkStockTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Brand", "Model", "Stock", "Kategori"
            }
        ));
        ...
        jLabel10.setText("Masukan model:");
        ...
        jLabel12.setText("Hapus Entry:");

        jLabel13.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 0, 0));
        jLabel13.setText("Masukan model:");
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptop", "Mobiles", "Part Komputer" }));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = LaptopDB.checkStock();
        ...
        list = PartKomputerDB.checkStock();
        
        for(int i=0; i<list.size(); i++){
            data[0] = list.get(i).getBrand();
            data[1] = list.get(i).getModel();
            data[2] = list.get(i).getQty();
            data[3] = "Part Komputer";
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        ...
        else if(mCat.getSelectedItem().equals("Laptop")){
            if(!path.equals(""))
                LaptopDB.insertIntoLaptopDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        else if(mCat.getSelectedItem().equals("Part Komputer")){
            if(!path.equals(""))
                PartKomputerDB.insertIntoPartKomputerDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Laptop")){
                LaptopDB.flag = true;
                LaptopDB.updateLaptopDB(model, qty);
            }
            ...
            else if(stockStatusCat.getSelectedItem().equals("Part Komputer")){
                PartKomputerDB.flag = true;
                PartKomputerDB.updatePartKomputerDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Laptop")){
            LaptopDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Mobiles")){
            MobileDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Part Komputer")){
            PartKomputerDB.delete(del);
        }
